...
rem ---------- LIST OF PLUGINS ---------------
set "PLUGINS=xvirtual_folders.plugin xmaterial.plugin xtexture.plugin xmaterial_instance.plugin xgeom.plugin xgeom_static.plugin xskeleton.plugin xanim_package.plugin xfont.plugin xgeom_skin.plugin"
